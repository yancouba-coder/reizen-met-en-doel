...
const SponsoredList = () => {
    ...
    const [filters, setFilters] = useState({ status: 'sponsored' });
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-text mb-4">{t('sponsored_list')}</h1>
                <p className="text-gray-600 max-w-2xl">
                    Celebrating the children who have found support.
